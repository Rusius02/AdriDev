        ...
        <div className="project-hologram-content">
          ...
          <div className="project-details">
            <div className="description-block">
              <h3><i className="fas fa-lightbulb"></i> L'IDÉE DERRIÈRE FINOVO</h3> 
              <p>{projectData.description}</p>
            </div>
            <div className="objective-block">
              <h3><i className="fas fa-cogs"></i> VISION & ARCHITECTURE</h3> 
          ...
          <div className="features-tech-section">
            <div className="features-block">
              <h3><i className="fas fa-star"></i> FONCTIONNALITÉS PRIORITAIRES</h3> 
              <ul>
            ...
            <div className="tech-used-block">
              <h3><i className="fas fa-code"></i> TECHNOLOGIES CLÉS</h3>
          ...
          <div className="roadmap-section">
            <h3><i className="fas fa-route"></i> FEUILLE DE ROUTE & MODULES FUTURS</h3>
            <ul>
